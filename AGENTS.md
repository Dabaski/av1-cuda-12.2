...
- l5_motion â€” motion::sad4x4 / sad8x8 / sad16x16 (strided uint8, bit-exact with svt_nxm_sad_kernel_helper_c) + GPU kernels for 4x4 and 8x8 only; the 16x16 D2 policy scores host-side (frame GPU tests are host-decides-gpu-executes, like 8x8).
